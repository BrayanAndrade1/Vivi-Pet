    ...
    <div class="container px-4 px-lg-5 mt-5">
        <div class="row">
            <div class="col-md-4">
                ...
                <hr>
                <div class="card card-outline shadow card-orange rounded-0">
                        ...
                        <a class="col px-1 py-2 text-decoration-none text-dark product-item" href="./?p=products/view_product&id=<?= $row['id'] ?>">
                            <div class="card rounded-0 shadow">
                                <div class="product-img-holder overflow-hidden position-relative">
                                    ...
                                    <span class="position-absolute price-tag rounded-pill bg-gradient-orange text-light px-3">
    ...
    $(function() {
        $('#brand_all').change(function() {
            if ($(this).is(':checked') == true) {
                $('.brand_filter').prop("checked", false).closest('.list-group-item').hide();
            } else {
                $('.brand_filter').closest('.list-group-item').show();
            }
        });
        
        $('#category_all').change(function() {
            if ($(this).is(':checked') == true) {
                $('.category_filter').prop("checked", false).closest('.list-group-item').hide();
            } else {
                $('.category_filter').closest('.list-group-item').show();
            }
        });
