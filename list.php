			...
			<div class="container-fluid">
				<table class="table table-bordered table-stripped">
					...
					<tbody>
						<?php
						$i = 1;
						$qry = $conn->query("SELECT *,concat(firstname,' ',lastname) as name, dni from `users` where id != '1' and id != '{$_settings->userdata('id')}' and `type` != 3 order by concat(firstname,' ',lastname) asc ");
						...
						?>
							<tr>
								...
								<td><?php echo ($row['type'] == 1) ? 'Administrator' : 'Empleado' ?></td>
								<td align="center">
