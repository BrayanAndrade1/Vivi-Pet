                ...
                <div class="container-fluid">
                    <form id="register-frm" action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <input type="text" name="dni" id="dni" placeholder="Ingresa tu Cédula" class="form-control form-control-sm form-control-border" required value="<?= isset($dni) ? $dni : "" ?>">
                                <small class="ml-3">DNI</small>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
