...
<aside class="main-sidebar sidebar-dark-primary elevation-4 sidebar-no-expand">
  <!-- Brand Logo -->
  <a href="<?php echo base_url ?>" class="brand-link bg-orange text-sm">
          ...
          <nav class="mt-4">
            <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <?php if ($_settings->userdata('type') == 1) : ?>
                ...
                <li class="nav-item dropdown">
                  <a href="<?php echo base_url ?>admin/?page=tools/brands" class="nav-link nav-tools_brands">
                ...
                <li class="nav-item dropdown">
                  <a href="<?php echo base_url ?>admin/?page=tools/category" class="nav-link nav-tools_category">
                ...
                <li class="nav-item dropdown">
                  <a href="<?php echo base_url ?>admin/?page=tools/services" class="nav-link nav-tools_services">
                    <i class="nav-icon fas fa-th-list"></i>
                    <p>
                      Servicios
                    </p>
