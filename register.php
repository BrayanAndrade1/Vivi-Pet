...
<body class="">
  ...
  <div class="d-flex align-items-center justify-content-center h-100">
    ...
    <div class="d-flex h-100 justify-content-center align-items-center col-lg-7 bg-warning text-dark">
      <div class="card card-outline card-orange w-75">
        ...
        <div class="card-body">
          <form id="register-frm" action="" method="post">
            ...
            <div class="row">
              ...
              <div class="form-group col-md-6">
                <input type="text" name="dni" id="dni" placeholder="Ingresa tu DNI" class="form-control form-control-sm form-control-border" required>           
                <small class="ml-3">Cédula</small>
              </div>
            </div>
            <div class="row">
              <div class="form-group col-md-6">
